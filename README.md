...
- [Squeezing 1TB Model Rollout into a Single H200: INT4 QAT RL End-to-End Practice](./rlhf/slime/int4/readme-en.md): Introduces the INT4 QAT RL end-to-end practice, including the technical details and the implementation of the INT4 QAT RL end-to-end practice. Also available in [Chinese version](./rlhf/slime/int4/readme.md).
